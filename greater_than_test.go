...
func (t *GreaterThanTest) NegativeIntegerLiteral() {
	...
	cases := []gtTestCase{
		...
		gtTestCase{int16(17), MATCH_TRUE, ""},

		gtTestCase{int32(-(1 << 30)), MATCH_FALSE, ""},
		...
		gtTestCase{int32(17), MATCH_TRUE, ""},

		gtTestCase{int64(-(1 << 30)), MATCH_FALSE, ""},
		...
		gtTestCase{int64(17), MATCH_TRUE, ""},

		// Unsigned integers.
		gtTestCase{uint((1 << 32) - 151), MATCH_TRUE, ""},
		gtTestCase{uint(0), MATCH_TRUE, ""},
		gtTestCase{uint(17), MATCH_TRUE, ""},

		gtTestCase{uint8(0), MATCH_TRUE, ""},
		gtTestCase{uint8(17), MATCH_TRUE, ""},
		gtTestCase{uint8(253), MATCH_TRUE, ""},

		gtTestCase{uint16((1 << 16) - 151), MATCH_TRUE, ""},
		gtTestCase{uint16(0), MATCH_TRUE, ""},
		gtTestCase{uint16(17), MATCH_TRUE, ""},

		gtTestCase{uint32((1 << 32) - 151), MATCH_TRUE, ""},
		gtTestCase{uint32(0), MATCH_TRUE, ""},
		gtTestCase{uint32(17), MATCH_TRUE, ""},

		gtTestCase{uint64((1 << 64) - 151), MATCH_TRUE, ""},
		gtTestCase{uint64(0), MATCH_TRUE, ""},
		gtTestCase{uint64(17), MATCH_TRUE, ""},

		// Floating point.
		gtTestCase{float32(-(1 << 30)), MATCH_FALSE, ""},
		...
		gtTestCase{float32(17), MATCH_TRUE, ""},
		gtTestCase{float32(160), MATCH_TRUE, ""},

		gtTestCase{float64(-(1 << 30)), MATCH_FALSE, ""},
		...
		gtTestCase{float64(17), MATCH_TRUE, ""},
		gtTestCase{float64(160), MATCH_TRUE, ""},
	}
...
func (t *GreaterThanTest) ZeroIntegerLiteral() {
	...
	cases := []gtTestCase{
		...
		// Unsigned integers.
		gtTestCase{uint((1 << 32) - 1), MATCH_TRUE, ""},
		gtTestCase{uint(0), MATCH_FALSE, ""},
		gtTestCase{uint(1), MATCH_TRUE, ""},
		gtTestCase{uint(17), MATCH_TRUE, ""},

		gtTestCase{uint8(0), MATCH_FALSE, ""},
		gtTestCase{uint8(1), MATCH_TRUE, ""},
		gtTestCase{uint8(17), MATCH_TRUE, ""},
		gtTestCase{uint8(253), MATCH_TRUE, ""},

		gtTestCase{uint16((1 << 16) - 1), MATCH_TRUE, ""},
		gtTestCase{uint16(0), MATCH_FALSE, ""},
		gtTestCase{uint16(1), MATCH_TRUE, ""},
		gtTestCase{uint16(17), MATCH_TRUE, ""},

		gtTestCase{uint32((1 << 32) - 1), MATCH_TRUE, ""},
		gtTestCase{uint32(0), MATCH_FALSE, ""},
		gtTestCase{uint32(1), MATCH_TRUE, ""},
		gtTestCase{uint32(17), MATCH_TRUE, ""},

		gtTestCase{uint64((1 << 64) - 1), MATCH_TRUE, ""},
		gtTestCase{uint64(0), MATCH_FALSE, ""},
		gtTestCase{uint64(1), MATCH_TRUE, ""},
		gtTestCase{uint64(17), MATCH_TRUE, ""},

		// Floating point.
		gtTestCase{float32(-(1 << 30)), MATCH_FALSE, ""},
		gtTestCase{float32(-1), MATCH_FALSE, ""},
		gtTestCase{float32(-0.1), MATCH_FALSE, ""},
		gtTestCase{float32(-0.0), MATCH_FALSE, ""},
		...
		gtTestCase{float64(-(1 << 30)), MATCH_FALSE, ""},
		gtTestCase{float64(-1), MATCH_FALSE, ""},
...
func (t *GreaterThanTest) PositiveIntegerLiteral() {
	...
	cases := []gtTestCase{
		...
		// Unsigned integers.
		gtTestCase{uint(0), MATCH_FALSE, ""},
		gtTestCase{uint(149), MATCH_FALSE, ""},
		gtTestCase{uint(150), MATCH_FALSE, ""},
		gtTestCase{uint(151), MATCH_TRUE, ""},

		gtTestCase{uint8(0), MATCH_FALSE, ""},
		gtTestCase{uint8(127), MATCH_FALSE, ""},

		gtTestCase{uint16(0), MATCH_FALSE, ""},
		gtTestCase{uint16(149), MATCH_FALSE, ""},
		gtTestCase{uint16(150), MATCH_FALSE, ""},
		gtTestCase{uint16(151), MATCH_TRUE, ""},

		gtTestCase{uint32(0), MATCH_FALSE, ""},
		gtTestCase{uint32(149), MATCH_FALSE, ""},
		gtTestCase{uint32(150), MATCH_FALSE, ""},
		gtTestCase{uint32(151), MATCH_TRUE, ""},

		gtTestCase{uint64(0), MATCH_FALSE, ""},
		gtTestCase{uint64(149), MATCH_FALSE, ""},
		gtTestCase{uint64(150), MATCH_FALSE, ""},
		gtTestCase{uint64(151), MATCH_TRUE, ""},

		// Floating point.
		gtTestCase{float32(-1), MATCH_FALSE, ""},
		gtTestCase{float32(149), MATCH_FALSE, ""},
		...
		gtTestCase{float64(-1), MATCH_FALSE, ""},
		gtTestCase{float64(149), MATCH_FALSE, ""},
...
func (t *GreaterThanTest) NegativeFloatLiteral() {
	...
	cases := []gtTestCase{
		...
		gtTestCase{float32(-(1 << 30)), MATCH_FALSE, ""},
		gtTestCase{float32(-151), MATCH_FALSE, ""},
		gtTestCase{float32(-150.2), MATCH_FALSE, ""},
		gtTestCase{float32(-150.1), MATCH_FALSE, ""},
		...
		gtTestCase{float64(-(1 << 30)), MATCH_FALSE, ""},
		gtTestCase{float64(-151), MATCH_FALSE, ""},
		gtTestCase{float64(-150.2), MATCH_FALSE, ""},
		gtTestCase{float64(-150.1), MATCH_FALSE, ""},
...
func (t *GreaterThanTest) PositiveFloatLiteral() {
	...
	cases := []gtTestCase{
		...
		gtTestCase{float32(-1), MATCH_FALSE, ""},
		gtTestCase{float32(149), MATCH_FALSE, ""},
		gtTestCase{float32(149.8), MATCH_FALSE, ""},
		gtTestCase{float32(149.9), MATCH_FALSE, ""},
		gtTestCase{float32(150), MATCH_TRUE, ""},
		gtTestCase{float32(151), MATCH_TRUE, ""},
		...
		gtTestCase{float64(-1), MATCH_FALSE, ""},
		gtTestCase{float64(149), MATCH_FALSE, ""},
		gtTestCase{float64(149.8), MATCH_FALSE, ""},
		gtTestCase{float64(149.9), MATCH_FALSE, ""},
		gtTestCase{float64(150), MATCH_TRUE, ""},
		gtTestCase{float64(151), MATCH_TRUE, ""},
	}
...
func (t *GreaterThanTest) Int64NotExactlyRepresentableBySinglePrecision() {
	...
	cases := []gtTestCase{
		// Signed integers.
		gtTestCase{-1, MATCH_FALSE, ""},
		gtTestCase{kTwoTo25 + 0, MATCH_FALSE, ""},
		gtTestCase{kTwoTo25 + 1, MATCH_FALSE, ""},
		gtTestCase{kTwoTo25 + 2, MATCH_TRUE, ""},

		gtTestCase{int(-1), MATCH_FALSE, ""},
		gtTestCase{int(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{int(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{int(kTwoTo25 + 2), MATCH_TRUE, ""},
		...
		gtTestCase{int16(-1), MATCH_FALSE, ""},
		gtTestCase{int16(0), MATCH_FALSE, ""},
		gtTestCase{int16(32767), MATCH_FALSE, ""},

		gtTestCase{int32(-1), MATCH_FALSE, ""},
		gtTestCase{int32(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{int32(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{int32(kTwoTo25 + 2), MATCH_TRUE, ""},

		gtTestCase{int64(-1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo25 + 2), MATCH_TRUE, ""},

		// Unsigned integers.
		gtTestCase{uint(0), MATCH_FALSE, ""},
		gtTestCase{uint(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{uint(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{uint(kTwoTo25 + 2), MATCH_TRUE, ""},

		gtTestCase{uint8(0), MATCH_FALSE, ""},
		gtTestCase{uint8(255), MATCH_FALSE, ""},

		gtTestCase{uint16(0), MATCH_FALSE, ""},
		gtTestCase{uint16(65535), MATCH_FALSE, ""},

		gtTestCase{uint32(0), MATCH_FALSE, ""},
		gtTestCase{uint32(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{uint32(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{uint32(kTwoTo25 + 2), MATCH_TRUE, ""},

		gtTestCase{uint64(0), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo25 + 2), MATCH_TRUE, ""},

		// Floating point.
		gtTestCase{float32(-1), MATCH_FALSE, ""},
		gtTestCase{float32(kTwoTo25 - 2), MATCH_FALSE, ""},
		gtTestCase{float32(kTwoTo25 - 1), MATCH_FALSE, ""},
		gtTestCase{float32(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{float32(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{float32(kTwoTo25 + 2), MATCH_FALSE, ""},
		gtTestCase{float32(kTwoTo25 + 3), MATCH_TRUE, ""},

		gtTestCase{float64(-1), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo25 - 2), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo25 - 1), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo25 + 0), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo25 + 2), MATCH_TRUE, ""},
		gtTestCase{float64(kTwoTo25 + 3), MATCH_TRUE, ""},
	}
...
func (t *GreaterThanTest) Int64NotExactlyRepresentableByDoublePrecision() {
	...
	cases := []gtTestCase{
		...
		gtTestCase{int(-1), MATCH_FALSE, ""},
		gtTestCase{int(math.MaxInt32), MATCH_FALSE, ""},
		...
		gtTestCase{int32(-1), MATCH_FALSE, ""},
		gtTestCase{int32(math.MaxInt32), MATCH_FALSE, ""},

		gtTestCase{int64(-1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo54 - 1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo54 + 0), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo54 + 1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo54 + 2), MATCH_TRUE, ""},

		// Unsigned integers.
		gtTestCase{uint(0), MATCH_FALSE, ""},
		gtTestCase{uint(math.MaxUint32), MATCH_FALSE, ""},
		...
		gtTestCase{uint32(0), MATCH_FALSE, ""},
		gtTestCase{uint32(math.MaxUint32), MATCH_FALSE, ""},

		gtTestCase{uint64(0), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo54 - 1), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo54 + 0), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo54 + 1), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo54 + 2), MATCH_TRUE, ""},

		// Floating point.
		gtTestCase{float64(-1), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo54 - 2), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo54 - 1), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo54 + 0), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo54 + 1), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo54 + 2), MATCH_FALSE, ""},
		gtTestCase{float64(kTwoTo54 + 3), MATCH_TRUE, ""},
	}
...
func (t *GreaterThanTest) Float32AboveExactIntegerRange() {
	...
	cases := []gtTestCase{
		...
		gtTestCase{int64(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo25 + 2), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo25 + 3), MATCH_TRUE, ""},
		...
		gtTestCase{uint64(kTwoTo25 + 1), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo25 + 2), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo25 + 3), MATCH_TRUE, ""},
...
func (t *GreaterThanTest) Float64AboveExactIntegerRange() {
	...
	cases := []gtTestCase{
		...
		gtTestCase{int64(kTwoTo54 + 1), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo54 + 2), MATCH_FALSE, ""},
		gtTestCase{int64(kTwoTo54 + 3), MATCH_TRUE, ""},
		...
		gtTestCase{uint64(kTwoTo54 + 1), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo54 + 2), MATCH_FALSE, ""},
		gtTestCase{uint64(kTwoTo54 + 3), MATCH_TRUE, ""},
...
func (t *GreaterThanTest) EmptyString() {
	...
	cases := []gtTestCase{
		gtTestCase{"", MATCH_FALSE, ""},
		gtTestCase{"\x00", MATCH_TRUE, ""},
		gtTestCase{"a", MATCH_TRUE, ""},
...
func (t *GreaterThanTest) LongerString() {
	...
	cases := []gtTestCase{
		gtTestCase{"", MATCH_FALSE, ""},
		gtTestCase{"\x00", MATCH_FALSE, ""},
		gtTestCase{"bar", MATCH_FALSE, ""},
		gtTestCase{"foo", MATCH_FALSE, ""},
		gtTestCase{"foo\x00", MATCH_FALSE, ""},
		gtTestCase{"foo\x00\x00", MATCH_TRUE, ""},
		gtTestCase{"fooa", MATCH_TRUE, ""},
		gtTestCase{"qux", MATCH_TRUE, ""},
	}
