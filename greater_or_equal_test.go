...
func (t *GreaterOrEqualTest) NegativeIntegerLiteral() {
	...
	cases := []geTestCase{
		...
		geTestCase{-150, MATCH_TRUE, ""},
		geTestCase{0, MATCH_TRUE, ""},
		geTestCase{17, MATCH_TRUE, ""},

		geTestCase{int(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{int(-151), MATCH_FALSE, ""},
		geTestCase{int(-150), MATCH_TRUE, ""},
		geTestCase{int(0), MATCH_TRUE, ""},
		geTestCase{int(17), MATCH_TRUE, ""},

		geTestCase{int8(-127), MATCH_TRUE, ""},
		geTestCase{int8(0), MATCH_TRUE, ""},
		geTestCase{int8(17), MATCH_TRUE, ""},

		geTestCase{int16(-(1 << 14)), MATCH_FALSE, ""},
		geTestCase{int16(-151), MATCH_FALSE, ""},
		geTestCase{int16(-150), MATCH_TRUE, ""},
		geTestCase{int16(0), MATCH_TRUE, ""},
		geTestCase{int16(17), MATCH_TRUE, ""},

		geTestCase{int32(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{int32(-151), MATCH_FALSE, ""},
		geTestCase{int32(-150), MATCH_TRUE, ""},
		geTestCase{int32(0), MATCH_TRUE, ""},
		geTestCase{int32(17), MATCH_TRUE, ""},

		geTestCase{int64(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{int64(-151), MATCH_FALSE, ""},
		geTestCase{int64(-150), MATCH_TRUE, ""},
		geTestCase{int64(0), MATCH_TRUE, ""},
		geTestCase{int64(17), MATCH_TRUE, ""},

		// Unsigned integers.
		geTestCase{uint((1 << 32) - 151), MATCH_TRUE, ""},
		geTestCase{uint(0), MATCH_TRUE, ""},
		geTestCase{uint(17), MATCH_TRUE, ""},

		geTestCase{uint8(0), MATCH_TRUE, ""},
		geTestCase{uint8(17), MATCH_TRUE, ""},
		geTestCase{uint8(253), MATCH_TRUE, ""},

		geTestCase{uint16((1 << 16) - 151), MATCH_TRUE, ""},
		geTestCase{uint16(0), MATCH_TRUE, ""},
		geTestCase{uint16(17), MATCH_TRUE, ""},

		geTestCase{uint32((1 << 32) - 151), MATCH_TRUE, ""},
		geTestCase{uint32(0), MATCH_TRUE, ""},
		geTestCase{uint32(17), MATCH_TRUE, ""},

		geTestCase{uint64((1 << 64) - 151), MATCH_TRUE, ""},
		geTestCase{uint64(0), MATCH_TRUE, ""},
		geTestCase{uint64(17), MATCH_TRUE, ""},

		// Floating point.
		geTestCase{float32(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{float32(-151), MATCH_FALSE, ""},
		geTestCase{float32(-150.1), MATCH_FALSE, ""},
		geTestCase{float32(-150), MATCH_TRUE, ""},
		geTestCase{float32(-149.9), MATCH_TRUE, ""},
		geTestCase{float32(0), MATCH_TRUE, ""},
		geTestCase{float32(17), MATCH_TRUE, ""},
		geTestCase{float32(160), MATCH_TRUE, ""},

		geTestCase{float64(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{float64(-151), MATCH_FALSE, ""},
		geTestCase{float64(-150.1), MATCH_FALSE, ""},
		geTestCase{float64(-150), MATCH_TRUE, ""},
		geTestCase{float64(-149.9), MATCH_TRUE, ""},
		geTestCase{float64(0), MATCH_TRUE, ""},
		geTestCase{float64(17), MATCH_TRUE, ""},
		geTestCase{float64(160), MATCH_TRUE, ""},
	}
...
func (t *GreaterOrEqualTest) ZeroIntegerLiteral() {
	...
	cases := []geTestCase{
		...
		// Unsigned integers.
		geTestCase{uint((1 << 32) - 1), MATCH_TRUE, ""},
		geTestCase{uint(0), MATCH_TRUE, ""},
		geTestCase{uint(17), MATCH_TRUE, ""},
		...
		geTestCase{uint16((1 << 16) - 1), MATCH_TRUE, ""},
		geTestCase{uint16(0), MATCH_TRUE, ""},
		geTestCase{uint16(17), MATCH_TRUE, ""},

		geTestCase{uint32((1 << 32) - 1), MATCH_TRUE, ""},
		geTestCase{uint32(0), MATCH_TRUE, ""},
		geTestCase{uint32(17), MATCH_TRUE, ""},

		geTestCase{uint64((1 << 64) - 1), MATCH_TRUE, ""},
		geTestCase{uint64(0), MATCH_TRUE, ""},
		geTestCase{uint64(17), MATCH_TRUE, ""},

		// Floating point.
		geTestCase{float32(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{float32(-1), MATCH_FALSE, ""},
		geTestCase{float32(-0.1), MATCH_FALSE, ""},
		geTestCase{float32(-0.0), MATCH_TRUE, ""},
		geTestCase{float32(0), MATCH_TRUE, ""},
		...
		geTestCase{float64(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{float64(-1), MATCH_FALSE, ""},
		geTestCase{float64(-0.1), MATCH_FALSE, ""},
		geTestCase{float64(-0), MATCH_TRUE, ""},
		geTestCase{float64(0), MATCH_TRUE, ""},
		geTestCase{float64(17), MATCH_TRUE, ""},
		geTestCase{float64(160), MATCH_TRUE, ""},
...
func (t *GreaterOrEqualTest) PositiveIntegerLiteral() {
	...
	cases := []geTestCase{
		// Signed integers.
		geTestCase{-1, MATCH_FALSE, ""},
		geTestCase{149, MATCH_FALSE, ""},
		geTestCase{150, MATCH_TRUE, ""},
		geTestCase{151, MATCH_TRUE, ""},

		geTestCase{int(-1), MATCH_FALSE, ""},
		geTestCase{int(149), MATCH_FALSE, ""},
		geTestCase{int(150), MATCH_TRUE, ""},
		...
		geTestCase{int16(-1), MATCH_FALSE, ""},
		geTestCase{int16(149), MATCH_FALSE, ""},
		geTestCase{int16(150), MATCH_TRUE, ""},
		geTestCase{int16(151), MATCH_TRUE, ""},

		geTestCase{int32(-1), MATCH_FALSE, ""},
		geTestCase{int32(149), MATCH_FALSE, ""},
		geTestCase{int32(150), MATCH_TRUE, ""},
		geTestCase{int32(151), MATCH_TRUE, ""},

		geTestCase{int64(-1), MATCH_FALSE, ""},
		geTestCase{int64(149), MATCH_FALSE, ""},
		geTestCase{int64(150), MATCH_TRUE, ""},
		geTestCase{int64(151), MATCH_TRUE, ""},

		// Unsigned integers.
		geTestCase{uint(0), MATCH_FALSE, ""},
		geTestCase{uint(149), MATCH_FALSE, ""},
		geTestCase{uint(150), MATCH_TRUE, ""},
		geTestCase{uint(151), MATCH_TRUE, ""},

		geTestCase{uint8(0), MATCH_FALSE, ""},
		geTestCase{uint8(127), MATCH_FALSE, ""},

		geTestCase{uint16(0), MATCH_FALSE, ""},
		geTestCase{uint16(149), MATCH_FALSE, ""},
		geTestCase{uint16(150), MATCH_TRUE, ""},
		geTestCase{uint16(151), MATCH_TRUE, ""},

		geTestCase{uint32(0), MATCH_FALSE, ""},
		geTestCase{uint32(149), MATCH_FALSE, ""},
		geTestCase{uint32(150), MATCH_TRUE, ""},
		geTestCase{uint32(151), MATCH_TRUE, ""},

		geTestCase{uint64(0), MATCH_FALSE, ""},
		geTestCase{uint64(149), MATCH_FALSE, ""},
		geTestCase{uint64(150), MATCH_TRUE, ""},
		geTestCase{uint64(151), MATCH_TRUE, ""},

		// Floating point.
		geTestCase{float32(-1), MATCH_FALSE, ""},
		geTestCase{float32(149), MATCH_FALSE, ""},
		...
		geTestCase{float64(-1), MATCH_FALSE, ""},
		geTestCase{float64(149), MATCH_FALSE, ""},
...
func (t *GreaterOrEqualTest) NegativeFloatLiteral() {
	...
	cases := []geTestCase{
		...
		geTestCase{float32(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{float32(-151), MATCH_FALSE, ""},
		geTestCase{float32(-150.2), MATCH_FALSE, ""},
		geTestCase{float32(-150.1), MATCH_TRUE, ""},
		geTestCase{float32(-150), MATCH_TRUE, ""},
		geTestCase{float32(0), MATCH_TRUE, ""},
		geTestCase{float32(17), MATCH_TRUE, ""},
		...
		geTestCase{float64(-(1 << 30)), MATCH_FALSE, ""},
		geTestCase{float64(-151), MATCH_FALSE, ""},
		geTestCase{float64(-150.2), MATCH_FALSE, ""},
		geTestCase{float64(-150.1), MATCH_TRUE, ""},
		geTestCase{float64(-150), MATCH_TRUE, ""},
		geTestCase{float64(0), MATCH_TRUE, ""},
		geTestCase{float64(17), MATCH_TRUE, ""},
...
func (t *GreaterOrEqualTest) PositiveFloatLiteral() {
	...
	cases := []geTestCase{
		...
		geTestCase{float32(-1), MATCH_FALSE, ""},
		geTestCase{float32(149), MATCH_FALSE, ""},
		geTestCase{float32(149.8), MATCH_FALSE, ""},
		geTestCase{float32(149.9), MATCH_TRUE, ""},
		geTestCase{float32(150), MATCH_TRUE, ""},
		geTestCase{float32(151), MATCH_TRUE, ""},
		...
		geTestCase{float64(-1), MATCH_FALSE, ""},
		geTestCase{float64(149), MATCH_FALSE, ""},
		geTestCase{float64(149.8), MATCH_FALSE, ""},
		geTestCase{float64(149.9), MATCH_TRUE, ""},
		geTestCase{float64(150), MATCH_TRUE, ""},
		geTestCase{float64(151), MATCH_TRUE, ""},
	}
...
func (t *GreaterOrEqualTest) Int64NotExactlyRepresentableBySinglePrecision() {
	...
	cases := []geTestCase{
		// Signed integers.
		geTestCase{-1, MATCH_FALSE, ""},
		geTestCase{kTwoTo25 + 0, MATCH_FALSE, ""},
		geTestCase{kTwoTo25 + 1, MATCH_TRUE, ""},
		geTestCase{kTwoTo25 + 2, MATCH_TRUE, ""},

		geTestCase{int(-1), MATCH_FALSE, ""},
		geTestCase{int(kTwoTo25 + 0), MATCH_FALSE, ""},
		geTestCase{int(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{int(kTwoTo25 + 2), MATCH_TRUE, ""},
		...
		geTestCase{int16(32767), MATCH_FALSE, ""},

		geTestCase{int32(-1), MATCH_FALSE, ""},
		geTestCase{int32(kTwoTo25 + 0), MATCH_FALSE, ""},
		geTestCase{int32(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{int32(kTwoTo25 + 2), MATCH_TRUE, ""},

		geTestCase{int64(-1), MATCH_FALSE, ""},
		geTestCase{int64(kTwoTo25 + 0), MATCH_FALSE, ""},
		geTestCase{int64(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{int64(kTwoTo25 + 2), MATCH_TRUE, ""},

		// Unsigned integers.
		geTestCase{uint(0), MATCH_FALSE, ""},
		geTestCase{uint(kTwoTo25 + 0), MATCH_FALSE, ""},
		geTestCase{uint(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{uint(kTwoTo25 + 2), MATCH_TRUE, ""},

		geTestCase{uint8(0), MATCH_FALSE, ""},
		geTestCase{uint8(255), MATCH_FALSE, ""},

		geTestCase{uint16(0), MATCH_FALSE, ""},
		geTestCase{uint16(65535), MATCH_FALSE, ""},

		geTestCase{uint32(0), MATCH_FALSE, ""},
		geTestCase{uint32(kTwoTo25 + 0), MATCH_FALSE, ""},
		geTestCase{uint32(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{uint32(kTwoTo25 + 2), MATCH_TRUE, ""},

		geTestCase{uint64(0), MATCH_FALSE, ""},
		geTestCase{uint64(kTwoTo25 + 0), MATCH_FALSE, ""},
		geTestCase{uint64(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{uint64(kTwoTo25 + 2), MATCH_TRUE, ""},

		// Floating point.
		geTestCase{float32(-1), MATCH_FALSE, ""},
		geTestCase{float32(kTwoTo25 - 2), MATCH_FALSE, ""},
		geTestCase{float32(kTwoTo25 - 1), MATCH_TRUE, ""},
		geTestCase{float32(kTwoTo25 + 0), MATCH_TRUE, ""},
		geTestCase{float32(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{float32(kTwoTo25 + 2), MATCH_TRUE, ""},
		geTestCase{float32(kTwoTo25 + 3), MATCH_TRUE, ""},
		...
		geTestCase{float64(kTwoTo25 + 3), MATCH_TRUE, ""},
	}
...
func (t *GreaterOrEqualTest) Int64NotExactlyRepresentableByDoublePrecision() {
	...
	cases := []geTestCase{
		...
		geTestCase{int(-1), MATCH_FALSE, ""},
		geTestCase{int(math.MaxInt32), MATCH_FALSE, ""},
		...
		geTestCase{int32(-1), MATCH_FALSE, ""},
		geTestCase{int32(math.MaxInt32), MATCH_FALSE, ""},
		...
		// Unsigned integers.
		geTestCase{uint(0), MATCH_FALSE, ""},
		geTestCase{uint(math.MaxUint32), MATCH_FALSE, ""},
		...
		geTestCase{uint32(0), MATCH_FALSE, ""},
		geTestCase{uint32(math.MaxUint32), MATCH_FALSE, ""},
		...
		geTestCase{float64(kTwoTo54 - 1), MATCH_TRUE, ""},
		geTestCase{float64(kTwoTo54 + 0), MATCH_TRUE, ""},
		geTestCase{float64(kTwoTo54 + 1), MATCH_TRUE, ""},
		geTestCase{float64(kTwoTo54 + 2), MATCH_TRUE, ""},
		geTestCase{float64(kTwoTo54 + 3), MATCH_TRUE, ""},
	}
...
func (t *GreaterOrEqualTest) Float32AboveExactIntegerRange() {
	...
	cases := []geTestCase{
		...
		geTestCase{int64(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{int64(kTwoTo25 + 2), MATCH_TRUE, ""},
		geTestCase{int64(kTwoTo25 + 3), MATCH_TRUE, ""},
		...
		geTestCase{uint64(kTwoTo25 + 1), MATCH_TRUE, ""},
		geTestCase{uint64(kTwoTo25 + 2), MATCH_TRUE, ""},
		geTestCase{uint64(kTwoTo25 + 3), MATCH_TRUE, ""},
...
func (t *GreaterOrEqualTest) Float64AboveExactIntegerRange() {
	...
	cases := []geTestCase{
		...
		geTestCase{int64(kTwoTo54 + 1), MATCH_TRUE, ""},
		geTestCase{int64(kTwoTo54 + 2), MATCH_TRUE, ""},
		geTestCase{int64(kTwoTo54 + 3), MATCH_TRUE, ""},
		...
		geTestCase{uint64(kTwoTo54 + 1), MATCH_TRUE, ""},
		geTestCase{uint64(kTwoTo54 + 2), MATCH_TRUE, ""},
		geTestCase{uint64(kTwoTo54 + 3), MATCH_TRUE, ""},
...
func (t *GreaterOrEqualTest) LongerString() {
	...
	cases := []geTestCase{
		...
		geTestCase{"bar", MATCH_FALSE, ""},
		geTestCase{"foo", MATCH_FALSE, ""},
		geTestCase{"foo\x00", MATCH_TRUE, ""},
		geTestCase{"fooa", MATCH_TRUE, ""},
		geTestCase{"qux", MATCH_TRUE, ""},
	}
